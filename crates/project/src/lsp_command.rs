...
use gpui::{App, AsyncApp, Entity, SharedString, TaskExt, prelude::FluentBuilder};
use language::{
    Bias, Buffer, CachedLspAdapter,
...
impl LspCommand for PerformRename {
    ...
    async fn response_from_proto(
        self,
        _message: proto::PerformRenameResponse,
        _lsp_store: Entity<LspStore>,
        _: Entity<Buffer>,
        mut _cx: AsyncApp,
    ) -> Result<ProjectTransaction> {
        todo!("response_from_proto");
    }
