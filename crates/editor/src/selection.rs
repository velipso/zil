...
impl Editor {
    ...
    fn select_columns(
        ...
        let selection_tail = columnar_state.selection_tail;
        let display_point = columnar_state.display_point;
        let tail = display_point.unwrap_or_else(|| selection_tail.to_display_point(display_map));
